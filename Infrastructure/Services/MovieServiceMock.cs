    ...
    public class MovieServiceMock : IMovieService
    {
        public List<MovieCard> Get30HighestGrossingMovies()
        {
            var movies = new List<MovieCard> {
                ...
                new MovieCard { Title = "Interstellar", Id = 22, PosterUrl = "https://image.tmdb.org/t/p/w342//gEU2QniE6E77NI6lCU6Mx1nBVxI.jpg" },
                new MovieCard { Title = "The Dark Knight", Id = 33, PosterUrl = "https://image.tmdb.org/t/p/w342//qJ2tW6WMUDux911r6m7haRef0WH.jpg" },
                new MovieCard { Title = "Deadpool", Id = 44, PosterUrl = "https://image.tmdb.org/t/p/w342//yGSxMiF0cYuAiyuve5DA6bnWEaI.jpg" },
